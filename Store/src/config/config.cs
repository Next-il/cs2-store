...
public static class Config_Config
{
	...
	private static void LoadConfig(string configPath)
	{
		...
		Config_Credits config_credits = new()
		{
			...
			VipBonus = bool.Parse(creditsTable["VipBonus"].ToString()!),
			MinimumPlayers = int.Parse(creditsTable["MinimumPlayers"].ToString()!)
		};
	...
	public class Config_Credits
	{
		...
		public bool VipBonus { get; set; } = false; // Check if he has the @css/vip flag, if so, for every "AmountActive", "AmountInActive" events, multiply by this param.
